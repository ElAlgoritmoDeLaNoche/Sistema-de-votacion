...
$exist = mysqli_num_rows($sq);
		...
		if($exist==1){
		$nam="<center><h4><font color='#FF0000'>El usuario ya existe intenta con otro.</h4></center></font>";
		unset($username);
...
echo "Felicitaciones inicia sesión para votar!  <a href= 'login.php'>Inicia Sesión </a>";
}
}
else {
	 $error="<center><h4><font color='#FF0000'>Oh a ocurrido un error al registrarte !</h4></center></font>";
     include"register.php";
}
?>
